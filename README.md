<p align="center">
  <img src="./assets/banner.svg" alt="Kevin Arias — Full-stack engineer" width="100%" />
</p>

I build products end to end — from the data model and API to the interface people actually touch. Mostly TypeScript, across web, mobile, and the services behind them. Based in Costa Rica.
...
**Backend** &nbsp;·&nbsp; Node.js · Express · GraphQL (federation) · Prisma · TypeORM
**Data & infra** &nbsp;·&nbsp; PostgreSQL · Supabase · REST

---

### Currently

Turning side projects into products — a CRM for small studios and a VAT tool for Costa Rican freelancers — and shipping `excel-bridge` as an open-source package.
